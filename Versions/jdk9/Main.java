package Versions.jdk9;

public class Main {
    public static void main(String[] args) {
//JDK1.9 新特性
//1. Java 平台级模块系统 额外的模块描述器
...
//3. JShell : 交互式 Java REPL jshell 的即时反馈
...
//4. 改进的 Javadoc 支持在 API 文档中的进行搜索
...
//8. HTTP/2 新的 HttpClient API 流和服务端推送
...
//9. 多版本兼容 JAR “META-INF/versions/9”
